...
~/ycsb-0.17.0/bin/ycsb.sh load basic -P ./writeheavy/writeheavy-zipfian > ./writeheavy/writeheavy-zipfian-load.txt
~/ycsb-0.17.0/bin/ycsb.sh run basic -P ./writeheavy/writeheavy-zipfian > ./writeheavy/writeheavy-zipfian-run.txt
cat ./writeheavy/writeheavy-zipfian-load.txt ./writeheavy/writeheavy-zipfian-run.txt > ./writeheavy/writeheavy-zipfian-data.txt
rm ./writeheavy/writeheavy-zipfian-load.txt ./writeheavy/writeheavy-zipfian-run.txt
