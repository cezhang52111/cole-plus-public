    ...
    while full_cnt < k {
        ...
        if state.0.addr != temp_var.0 {
            ...
            if temp_var.0 != min_state.0 && temp_var.0 != max_state.0 {
                ...
                lower_cdc_tree = read_lower_cdc_tree(input_index, &mut offset_index_counter, &mut upper_mht_readers, &mut lower_cdc_tree_readers, cache_manager);
            }
            ...
            if prev_input_index != input_index {
                ...
                let another_lower_cdc_tree = read_lower_cdc_tree(input_index, &mut offset_index_counter, &mut upper_mht_readers, &mut lower_cdc_tree_readers, cache_manager);
